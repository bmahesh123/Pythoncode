...
class SalVsPosition_SVR:
    try:
        @staticmethod
        def SalVsPosition_SVR():
            ...
            # Using three Diff Algorithm to calculate accuracy of model,find which one produced higher salary
            ...
            plt.xlabel('Position level X-Axis')
...
SalVsPosition_SVR.SalVsPosition_SVR()
